import {
    ...
    PRODUCT_LIST_FAIL,
    PRODUCT_LIST_BY_SEARCH_QUERY_REQUEST,
    PRODUCT_LIST_BY_SEARCH_QUERY_SUCCESS,
    PRODUCT_LIST_BY_SEARCH_QUERY_FAIL,
...
export const productListBySearchQueryReducer = (state = { products: [] }, action) => {
    switch (action.type) {
        case PRODUCT_LIST_BY_SEARCH_QUERY_REQUEST:
            return { loading: true, products: [] };
        case PRODUCT_LIST_BY_SEARCH_QUERY_SUCCESS:
            return {
                loading: false,
                products: action.payload,
            };
        case PRODUCT_LIST_BY_SEARCH_QUERY_FAIL:
            return { loading: false, error: action.payload };
        default:
            return state;
    }
